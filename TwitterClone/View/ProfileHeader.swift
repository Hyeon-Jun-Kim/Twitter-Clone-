...
protocol ProfileHeaderDelegte: class {
...
class ProfileHeader: UICollectionReusableView {
    ...
    weak var delegate: ProfileHeaderDelegte?
    ...
    private let followingLabel: UILabel = {
        ...
        let followTap = UITapGestureRecognizer(target: self, action: #selector(hadleFollowersTapped))
    ...
    private let followersLabel: UILabel = {
        ...
        let followTap = UITapGestureRecognizer(target: self, action: #selector(hadleFollowingTapped))
        label.isUserInteractionEnabled = true
        label.addGestureRecognizer(followTap)
    ...
    @objc func hadleFollowersTapped() {
        
    }
    
    @objc func hadleFollowingTapped() {
